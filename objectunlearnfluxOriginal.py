# -*- coding: utf-8 -*-
"""ObjectUnlearnFlux.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1x01bwEUs_OC3bK8uQBmBTJW-FTVKN0PW
...
# ==========================================================================
TARGET_CONCEPT = "Bird"        # Concept to unlearn (e.g., "Dog", "Van_Gogh")
...
if STEERING_MODE == "hybrid":
    ...
    # Pincer_v2 + style: diverse prompt pairs
...
DIAG_PROMPT = f"A {TARGET_CONCEPT.replace('_', ' ')} sitting on a tree."
DIAG_SEED = 42
...
if STEERING_MODE == "pincer_v2":
    configs = [
        ("clip=3,t5=1",         {"clip": 3.0, "t5": 1.0},   True),
        ("clip=3,t5=2",         {"clip": 3.0, "t5": 2.0},   True),
        ("clip=3,t5=3",         {"clip": 3.0, "t5": 3.0},   True),
        ("clip=3,t5=4",        {"clip": 3.0, "t5": 4.0},  True),
        ("clip=3,t5=5",  {"clip": 3.0, "t5": 5.0},   True),
